      ...
      <div className="px-8 py-6 mt-4 text-left bg-white shadow-lg rounded-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-baseline justify-between mt-4">
            <button className="px-6 py-2 mt-4 text-white bg-green-600 rounded-lg hover:bg-green-700 w-full">Login</button>
          </div>
        </form>
        ...
        <div className="mt-4 text-center">
          ...
          <Link to="/register" className="text-sm text-green-600 hover:underline">Register here</Link>
        </div>
      </div>
    </div>
  )
